...
#SBATCH -A CORE-WCHN-MELD-SL2-GPU  # use CORE-WCHN-MELD-SL2-CPU for CPU only run
...
#source activate $CONDA_PATH; $CONDA_PATH/bin/python $MELD_PATH/scripts/classifier/ensemble.py --exp iteration_21-04-23 --ensemble-experiment-path iteration_21-04-23 --ensemble-exp-name iteration"
