...
data_parameters = {
    ...
    # Possible values:
    #  - '{site_code}_{group}_featurematrix.hdf5' for non-combat normalized data
    #  - '{site_code}_{group}_featurematrix_combat.hdf5' for combat normalized data
    #  - '{site_code}_{group}_featurematrix_combat_2.hdf5' for combat normalized data
    #  - '{site_code}_{group}_featurematrix_combat_3.hdf5' for combat normalized data with H27
